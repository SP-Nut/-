      ...
      <div className="w-full hero-inner px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        <div className="max-w-[900px] w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center px-2 sm:px-4 lg:px-0">
            ...
            <a
              href="#contact"
              className="w-full sm:w-auto h-11 sm:h-12 px-6 sm:px-8 lg:px-10 flex items-center justify-center bg-[#b49a74] text-white font-semibold tracking-wide text-xs sm:text-[13px] leading-none rounded-md sm:rounded-none shadow-[0_2px_8px_-2px_rgba(0,0,0,0.45)] hover:brightness-[1.07] focus:outline-none focus:ring-2 focus:ring-[#b49a74]/60 transition-all duration-200 touch-manipulation active:scale-95"
            >ขอใบเสนอราคา</a>
            
            {/* Secondary CTA - Mobile optimized */}
            <a
              href="#portfolio"
              className="w-full sm:w-auto h-11 sm:h-12 px-6 sm:px-8 lg:px-10 flex items-center justify-center border border-white text-white font-semibold tracking-wide text-xs sm:text-[13px] leading-none hover:bg-white hover:text-[#0b1118] transition-all duration-200 rounded-md sm:rounded-none touch-manipulation active:scale-95"
            >ดูผลงาน</a>
          </div>
        </div>
      </div>
